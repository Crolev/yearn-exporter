...
class Treasury:
    ...
    def __init__(self, label, wallets, watch_events_forever=False, start_block=0):
        ...
        ]  # Transfers into Treasury wallets
        self._topics_out = [
            '0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef',
            ['0x000000000000000000000000' + address[2:] for address in self.addresses],
        ]  # Transfers out of Treasury wallets
    ...
    def watch_transfers(self):
        ...
        self.log_filter_in = web3.eth.filter({"fromBlock": self._start_block, "topics": self._topics_in})
        self.log_filter_out = web3.eth.filter({"fromBlock": self._start_block, "topics": self._topics_out})
